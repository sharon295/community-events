...
import { MAX_CATEGORY_TAGS, MAX_DESCRIPTION_WORDS, SECTIONS } from "./constants";
...
function validate(data) {
  ...
  if (countWords(data.description) > MAX_DESCRIPTION_WORDS) {
    errors.push(`Description must be ${MAX_DESCRIPTION_WORDS} words or less.`);
  }
